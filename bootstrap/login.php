...
<?php	
	...
	if(isset($_POST['loginSubmit'])) // If the user pressed the Submit button
	{
		...
		if ($uname == "username" && $pass == "password")
		{
			...
			if ($_SERVER['HTTP_REFERER'] == "http://csis.svsu.edu/~kathayer/bootstrap/bootstrap/index.php" 
			    || $_SERVER['HTTP_REFERER'] == "http://csis.svsu.edu/~kathayer/bootstrap/bootstrap/login.php" )
			{
...
<body>
	...
	<p>
	<img src="ThayerMarineLogo.PNG" class="companylogo">
	</p>
